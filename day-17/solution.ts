...
type typesVersus1<TVersus extends RockPaperScissors> = {
  '👊🏻': StoneVersus[TVersus];
  '🖐🏾': PaperVersus[TVersus];
  '✌🏽': ScissorsVersus[TVersus];
};

type WhoWins<TVersus1 extends RockPaperScissors, TVersus2 extends RockPaperScissors> = typesVersus1<TVersus2>[TVersus1];
