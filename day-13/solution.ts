...
type DayCounter<
  ...
  TUnion = never
> = GetArrayLength<TArray> extends TStart
  ? GetArrayLength<TArray> extends TEnd
    ? TStart
    : DayCounter<TStart, TEnd, AddOneToArray<TArray>, true, TUnion | GetArrayLength<TArray>>
  : TStarted extends true
  ? GetArrayLength<TArray> extends TEnd
    ? TUnion | GetArrayLength<TArray>
    : DayCounter<TStart, TEnd, AddOneToArray<TArray>, true, TUnion | GetArrayLength<TArray>>
  : DayCounter<TStart, TEnd, AddOneToArray<TArray>, true, TUnion>;
