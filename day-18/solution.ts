...
type Count<TList extends string[], TSearch extends string, TArray extends unknown[] = []> = TList extends [
  string,
  ...infer TRemaining extends string[]
]
  ? TList extends [TSearch, ...string[]]
    ? Count<TRemaining, TSearch, AddOneToArray<TArray>>
    : Count<TRemaining, TSearch, TArray>
