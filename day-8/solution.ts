type KeysRemoveNaughty<T extends {[key: string]: unknown}> = {[key in keyof T]-?: key extends `naughty${string}` ? never :key}[keyof T] 

type RemoveNaughtyChildren<T extends {[key: string]: unknown}> = Pick<T, KeysRemoveNaughty<T>>
// TEST
